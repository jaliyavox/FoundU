...
/// <summary>Same rules as creating one - an edit must not let a report slip past them.</summary>
public class UpdateLostReportRequestValidator : AbstractValidator<UpdateLostReportRequest>
{
    public UpdateLostReportRequestValidator()
    {
