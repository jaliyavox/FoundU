  ...
  return (
    <SidebarProvider>
      ...
      >
        ...
        {/* Same white gradient the page panels wear, so the rail reads as one of them
            rather than a separate chrome. It sits above the blooms and below the content. */}
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 bg-linear-to-b from-white/70 via-white/25 to-transparent dark:from-white/[0.09] dark:via-white/[0.03]"
        />
        <PanelSheen />
        ...
        <PanelDivider className="mx-2 w-auto" />
      ...
      {/* Radius matched to the panels and the rail. The inset cannot clip its children -
          overflow-hidden here would make it a scroll container and break the sticky header -
          so the header and the content below round their own outer corners to suit. */}
      <SidebarInset className="md:peer-data-[variant=inset]:rounded-2xl">
        ...
        <header className="sticky top-0 z-10 flex h-16 shrink-0 items-center gap-2 bg-linear-to-b from-white/75 to-white/40 px-4 backdrop-blur-md sm:px-6 md:rounded-t-2xl dark:from-white/[0.07] dark:to-white/[0.02]">
          <PanelSheen />
          {/* A fading rule instead of a hard border, matching the panel dividers below. */}
          <PanelDivider className="absolute inset-x-0 bottom-0" />
        ...
        <div className="relative flex-1 bg-linear-to-b from-background to-muted/50 md:rounded-b-2xl">
          ...
          <div
            aria-hidden="true"
            className="pointer-events-none absolute inset-0 overflow-hidden md:rounded-b-2xl"
          >
